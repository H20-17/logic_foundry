...
mpM, exclMidM, simpLM, simpRM, absurdM, doubleNegElimM, deMorganConjM, 
       ...
       HelperConstraints r s o tType sE eL m
...
negAndNotToOrM :: HelperConstraints r1 s o tType sE eL m
...
doubleNegIntroM :: (HelperConstraints r1 s o tType sE eL m) 
...
exFalsoM :: HelperConstraints r1 s o tType sE eL m =>
...
disjunctiveSyllogismM :: (HelperConstraints r1 s o tType sE eL m) =>
...
-- | From P ↔ Q, derive ¬P ↔ ¬Q 
posBicondToNegBicondM :: (HelperConstraints r1 s o tType sE eL m) =>
    s -> -- ^ The proposition P ↔ Q
    ProofGenTStd tType r1 s o m (s, [Int])
...
-- | From ¬P ↔ ¬Q, derive P ↔ Q.
negBicondToPosBicondM :: (HelperConstraints r1 s o tType sE eL m) =>
    s -> -- ^ The proposition ¬P ↔ ¬Q
    ProofGenTStd tType r1 s o m (s, [Int])
...
deconstructAdjM :: (HelperConstraints r1 s o tType sE eL m) =>
    s -> -- ^ The proposition ¬P ↔ ¬Q
